    ...
    <div class="layuimini-main">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="ips" id="ips" placeholder="192.168.0.1/192.168.0.2" autocomplete="off" style="display: none;width: 400px;" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.use(['form','jquery','layer','laydate'], function () {
        ...
        form.on('select(bounds)', function (data) {
            if(data.value == "1"){
                $('#ips').show();
            }else{
                $('#ips').hide();
