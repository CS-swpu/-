        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                ...
                <button class="layui-btn layui-btn-sm layui-btn-sm data-delete-btn" lay-event="query_detail">
                    <i class="fa fa-search"></i>
                    问卷详情 </button>
                <button class="layui-btn layui-btn-sm layui-btn-sm data-delete-btn" lay-event="share">
                    <i class="fa fa-search"></i>
                    分享问卷 </button>
                <button class="layui-btn layui-btn-sm layui-btn-sm data-delete-btn" lay-event="excel">
                    <i class="fa fa-search"></i>
                    问卷导出 </button>
