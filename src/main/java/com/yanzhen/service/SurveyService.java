...
public class SurveyService {
    ...
    public List<Survey> queryNew(String title){
        Map<String,Object> map = new HashMap<>();
        map.put("title",title);
        return surveyDao.queryNew(map);
    }
    public List<Survey> queryHot(String title){
        Map<String,Object> map = new HashMap<>();
        map.put("title",title);
        return surveyDao.queryHot(map);
    }
    ...
    public List<Map<String, Object>> excel(Integer id){
        return surveyDao.excel(id);
    }
    ...
    public List<AnswerTxt> queryAnswerTxt(AnswerTxt answerTxt){
        Map<String, Object> map = MapParameter.getInstance().put(BeanMapUtils.beanToMap(answerTxt)).getMap();
        return answerTxtDao.query(map);
    }
